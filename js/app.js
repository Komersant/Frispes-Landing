(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-introducing")) new core(".slider-introducing", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".slider-our-spaces")) new core(".slider-our-spaces", {
            ...
            navigation: {
                prevEl: ".our-spaces__arrow_left",
                nextEl: ".our-spaces__arrow_right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".gallery-slider")) new core(".gallery-slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        if (document.querySelector(".slider-what-our-customers")) new core(".slider-what-our-customers", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            loop: true,
            pagination: {
                el: ".slider-what-our-customers__pagination",
                type: "progressbar"
            },
            navigation: {
                prevEl: ".header-block-arrows__arrow_left",
                nextEl: ".header-block-arrows__arrow_right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
    ...
    window.addEventListener("scroll", (function() {
        if (this.window.pageYOffset > 10) header.classList.add("_scroll"); else header.classList.remove("_scroll");
    }));
    const picker = datepicker("[data-calendar]", {
        isMobile: true,
        autoClose: true
    });
    picker.calendarContainer.style.setProperty("font-size", "16px");
    const active = document.getElementById("active");
    document.addEventListener("click", (function(event) {
        const contain = event.target.classList.contains("form-introducing__input");
        if (contain) active.classList.add("_active"); else active.classList.remove("_active");
    }));
})();